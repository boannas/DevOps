...
#include "lab1_interface/srv/detail/set_noise__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_lab1_interface
cdr_serialize(
  const lab1_interface::srv::SetNoise_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lab1_interface::srv::SetNoise_Request & ros_message)
{
  // Member: mean
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lab1_interface::srv::SetNoise_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lab1_interface::srv::SetNoise_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lab1_interface::srv::SetNoise_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_lab1_interface
const rosidl_message_type_support_t *
get_message_type_support_handle<lab1_interface::srv::SetNoise_Request>()
{
  return &lab1_interface::srv::typesupport_fastrtps_cpp::_SetNoise_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lab1_interface, srv, SetNoise_Request)() {
  return &lab1_interface::srv::typesupport_fastrtps_cpp::_SetNoise_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_lab1_interface
cdr_serialize(
  const lab1_interface::srv::SetNoise_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lab1_interface::srv::SetNoise_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = lab1_interface::srv::SetNoise_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lab1_interface::srv::SetNoise_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<lab1_interface::srv::SetNoise_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &lab1_interface::srv::typesupport_fastrtps_cpp::_SetNoise_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lab1_interface, srv, SetNoise_Response)() {
  return &lab1_interface::srv::typesupport_fastrtps_cpp::_SetNoise_Response__handle;
}
...
{
  return &lab1_interface::srv::typesupport_fastrtps_cpp::_SetNoise__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lab1_interface, srv, SetNoise)() {
  return &lab1_interface::srv::typesupport_fastrtps_cpp::_SetNoise__handle;
}
