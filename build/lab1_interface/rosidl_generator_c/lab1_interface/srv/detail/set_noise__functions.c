...
lab1_interface__srv__SetNoise_Request__init(lab1_interface__srv__SetNoise_Request * msg)
{
  ...
  if (!std_msgs__msg__Float64__init(&msg->mean)) {
    lab1_interface__srv__SetNoise_Request__fini(msg);
    return false;
  }
  // variance
...
lab1_interface__srv__SetNoise_Request__create()
{
  ...
  lab1_interface__srv__SetNoise_Request * msg = (lab1_interface__srv__SetNoise_Request *)allocator.allocate(sizeof(lab1_interface__srv__SetNoise_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lab1_interface__srv__SetNoise_Request));
  bool success = lab1_interface__srv__SetNoise_Request__init(msg);
  if (!success) {
...
lab1_interface__srv__SetNoise_Request__Sequence__init(lab1_interface__srv__SetNoise_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lab1_interface__srv__SetNoise_Request * data = NULL;

  if (size) {
    data = (lab1_interface__srv__SetNoise_Request *)allocator.zero_allocate(size, sizeof(lab1_interface__srv__SetNoise_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lab1_interface__srv__SetNoise_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        lab1_interface__srv__SetNoise_Request__fini(&data[i - 1]);
      }
...
lab1_interface__srv__SetNoise_Request__Sequence__fini(lab1_interface__srv__SetNoise_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      lab1_interface__srv__SetNoise_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lab1_interface__srv__SetNoise_Request__Sequence * array = (lab1_interface__srv__SetNoise_Request__Sequence *)allocator.allocate(sizeof(lab1_interface__srv__SetNoise_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lab1_interface__srv__SetNoise_Request__Sequence__init(array, size);
  if (!success) {
...
lab1_interface__srv__SetNoise_Request__Sequence__destroy(lab1_interface__srv__SetNoise_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lab1_interface__srv__SetNoise_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lab1_interface__srv__SetNoise_Request__Sequence__are_equal(const lab1_interface__srv__SetNoise_Request__Sequence * lhs, const lab1_interface__srv__SetNoise_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lab1_interface__srv__SetNoise_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lab1_interface__srv__SetNoise_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lab1_interface__srv__SetNoise_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lab1_interface__srv__SetNoise_Request * data =
      (lab1_interface__srv__SetNoise_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lab1_interface__srv__SetNoise_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lab1_interface__srv__SetNoise_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!lab1_interface__srv__SetNoise_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lab1_interface__srv__SetNoise_Response * msg = (lab1_interface__srv__SetNoise_Response *)allocator.allocate(sizeof(lab1_interface__srv__SetNoise_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lab1_interface__srv__SetNoise_Response));
  bool success = lab1_interface__srv__SetNoise_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
lab1_interface__srv__SetNoise_Response__destroy(lab1_interface__srv__SetNoise_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    lab1_interface__srv__SetNoise_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
lab1_interface__srv__SetNoise_Response__Sequence__init(lab1_interface__srv__SetNoise_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lab1_interface__srv__SetNoise_Response * data = NULL;

  if (size) {
    data = (lab1_interface__srv__SetNoise_Response *)allocator.zero_allocate(size, sizeof(lab1_interface__srv__SetNoise_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lab1_interface__srv__SetNoise_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        lab1_interface__srv__SetNoise_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
lab1_interface__srv__SetNoise_Response__Sequence__fini(lab1_interface__srv__SetNoise_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      lab1_interface__srv__SetNoise_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lab1_interface__srv__SetNoise_Response__Sequence * array = (lab1_interface__srv__SetNoise_Response__Sequence *)allocator.allocate(sizeof(lab1_interface__srv__SetNoise_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lab1_interface__srv__SetNoise_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
lab1_interface__srv__SetNoise_Response__Sequence__destroy(lab1_interface__srv__SetNoise_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lab1_interface__srv__SetNoise_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lab1_interface__srv__SetNoise_Response__Sequence__are_equal(const lab1_interface__srv__SetNoise_Response__Sequence * lhs, const lab1_interface__srv__SetNoise_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lab1_interface__srv__SetNoise_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lab1_interface__srv__SetNoise_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lab1_interface__srv__SetNoise_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lab1_interface__srv__SetNoise_Response * data =
      (lab1_interface__srv__SetNoise_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lab1_interface__srv__SetNoise_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lab1_interface__srv__SetNoise_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!lab1_interface__srv__SetNoise_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
