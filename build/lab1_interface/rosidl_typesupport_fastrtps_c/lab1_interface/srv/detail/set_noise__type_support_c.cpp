...
#include "lab1_interface/srv/detail/set_noise__rosidl_typesupport_fastrtps_c.h"
...
#include "lab1_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_lab1_interface
...
using _SetNoise_Request__ros_msg_type = lab1_interface__srv__SetNoise_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lab1_interface
size_t get_serialized_size_lab1_interface__srv__SetNoise_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetNoise_Request__ros_msg_type * ros_message = static_cast<const _SetNoise_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetNoise_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lab1_interface__srv__SetNoise_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lab1_interface
size_t max_serialized_size_lab1_interface__srv__SetNoise_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lab1_interface__srv__SetNoise_Request;
    is_plain =
      (
...
static size_t _SetNoise_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lab1_interface__srv__SetNoise_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lab1_interface, srv, SetNoise_Request)() {
...
using _SetNoise_Response__ros_msg_type = lab1_interface__srv__SetNoise_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lab1_interface
size_t get_serialized_size_lab1_interface__srv__SetNoise_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetNoise_Response__ros_msg_type * ros_message = static_cast<const _SetNoise_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_lab1_interface__srv__SetNoise_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lab1_interface
size_t max_serialized_size_lab1_interface__srv__SetNoise_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = lab1_interface__srv__SetNoise_Response;
    is_plain =
      (
...
static size_t _SetNoise_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lab1_interface__srv__SetNoise_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lab1_interface, srv, SetNoise_Response)() {
...
// already included above
// #include "lab1_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "lab1_interface/srv/set_noise.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lab1_interface, srv, SetNoise)() {
