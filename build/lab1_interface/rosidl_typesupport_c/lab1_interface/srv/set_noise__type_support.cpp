...
static const _SetNoise_Request_type_support_symbol_names_t _SetNoise_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lab1_interface, srv, SetNoise_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lab1_interface, srv, SetNoise_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lab1_interface, srv, SetNoise_Request)() {
  return &::lab1_interface::srv::rosidl_typesupport_c::SetNoise_Request_message_type_support_handle;
}
...
static const _SetNoise_Response_type_support_symbol_names_t _SetNoise_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lab1_interface, srv, SetNoise_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lab1_interface, srv, SetNoise_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lab1_interface, srv, SetNoise_Response)() {
  return &::lab1_interface::srv::rosidl_typesupport_c::SetNoise_Response_message_type_support_handle;
}
...
static const _SetNoise_type_support_symbol_names_t _SetNoise_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lab1_interface, srv, SetNoise)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lab1_interface, srv, SetNoise)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, lab1_interface, srv, SetNoise)() {
  return &::lab1_interface::srv::rosidl_typesupport_c::SetNoise_service_type_support_handle;
}
