...
class Metaclass_SetNoise_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('lab1_interface')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_SetNoise(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from lab1_interface.srv import _set_noise
...
class SetNoise(metaclass=Metaclass_SetNoise):
    from lab1_interface.srv._set_noise import SetNoise_Request as Request
    from lab1_interface.srv._set_noise import SetNoise_Response as Response
